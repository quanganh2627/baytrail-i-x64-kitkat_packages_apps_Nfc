...
/*set to 2~3 sec for the transceive time out : block read is slow in felica*/
#define FELICA_TIMEOUT_CUSTOM 0x07FF

/*set to 255 ms for the transceive time out */
#define MIFARE_TIMEOUT_CUSTOM 0xFF
