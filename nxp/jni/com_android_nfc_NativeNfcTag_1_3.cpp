   ...
   jobject o, jbyteArray data, jboolean raw, jintArray statusTargetLost)
{
    ...
    switch (selectedTech) {
        ...
        case TARGET_TYPE_ISO14443_3B:
           ...
           if(selectedLibNfcType == phNfc_eISO14443_3B_PICC){
              transceive_info.cmd.Iso144434Cmd = phNfc_eIso14443_3B_Raw;
              offset=0;
              transceive_info.addr = 0;
           }
           break;
...
static jboolean com_android_nfc_NativeNfcTag_doMakeReadonly(JNIEnv *e, jobject o, jbyteArray key)
{
    ...
    REENTRANCE_LOCK();
   status = phLibNfc_ConvertToReadOnlyNdef_Extension(handle, &keyBuffer, nfc_jni_readonly_callback,
           (void *)&cb_data);
    REENTRANCE_UNLOCK();
